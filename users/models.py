...
class User(AbstractUser):
    ...
    id_number = models.CharField(max_length=30,default='110108199901216982')

    xue_li = models.CharField(max_length=30,default='本科')
    school = models.CharField(max_length=30,default='北京师范大学')
    graduate_time = models.CharField(max_length=20,default='2000-10-10')
    job_join_time = models.CharField(max_length=20,default='2009-10-10')
